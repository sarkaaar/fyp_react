...
export default function HomePage() {
  ...
  return (
    <div className="relative bg-white overflow-hidden">
      ...
      <hr />
      <div>
        <h1 className="text-2xl md:text-4xl mt-12 mx-8 md:mx-20 underline underline-offset-8">
          Foods
        </h1>
      </div>
        ...
        <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            {products.map((product) => (
              <div key={product.id} className="group relative md:border hover:border-b-black">
                ...
                <div className="mt-4 flex justify-between shadow-md md:shadow-none">
                  <div>
