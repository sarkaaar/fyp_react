    ...
    <div className="z-10 border-gray-800">
      <div className="flex bg-gray-900 justify-between p-12">
        ...
        <div>
          ...
          <h2 className="text-lg text-white p-2"><FacebookIcon/> FaceBook</h2>
          <h2 className="text-lg text-white p-2"><InstagramIcon/> Instagram</h2>
          <h2 className="text-lg text-white p-2"><TwitterIcon/> Twitter</h2>
          <h2 className="text-lg text-white p-2"><YouTubeIcon/> Youtube</h2>
        </div>
