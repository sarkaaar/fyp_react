      ...
      <div className="flex flex-col items-center pb-10">
        ...
        <div className="mt-4 flex space-x-3 lg:mt-6">
          <Link
            ...
            className="inline-flex items-center rounded-lg bg-gradient-to-r from-indigo-600 to-blue-500 py-2 px-4 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            View on Map
          </Link>
          {/* <a
          ...
          <a
            ...
            className="inline-flex items-center rounded-lg bg-gradient-to-r from-gray-400 to-gray-900 py-2 px-4 text-center text-sm font-medium text-white hover:opacity-90 focus:outline-none focus:ring-4 focus:ring-gray-200"
          >
            Book Appointment
          </a>
        </div>
